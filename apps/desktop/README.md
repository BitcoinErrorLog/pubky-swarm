...
Torrents' recent RSS feed is the sole built-in external source. Torznab API keys
remain in memory for the current process and must be entered again after restart.
