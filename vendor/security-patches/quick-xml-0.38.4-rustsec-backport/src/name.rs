...
pub enum NamespaceError {
    ...
    /// A single start tag declared more namespace bindings than the configured
    /// [`NamespaceResolver::max_declarations_per_element`] limit.
    ///
...
impl fmt::Display for NamespaceError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::TooManyDeclarations(limit) => write!(
                f,
                "start tag declares more than {limit} namespace bindings; \
...
impl NamespaceResolver {
    ...
    /// Returns the maximum namespace declarations accepted on one start tag.
    #[inline]
